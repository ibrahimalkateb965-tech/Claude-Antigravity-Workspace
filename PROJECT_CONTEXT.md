...
| **نظام الخطافات التلقائي (Auto-Hooks)** | 21 خطافاً تلقائياً موجهاً بالمحفزات | استجابة فورية وتفعيل تلقائي للوكلاء بناءً على الكلمات المفتاحية دون الحاجة لإعادة توجيه يدوي. |
...
│   ├── HOOKS_GUIDE.md           # الدليل الفني للخطافات التلقائية الـ 21
...
* **المكونات النشطة والمكتملة:**
  - [x] منظومة الخطافات التلقائية الـ 21 الموثقة بالكامل في `HOOKS_GUIDE.md` و `HOOKS_GUIDE.xlsx`.
  ...
  - [x] تطبيق مكتبة الأوامر التفاعلية الديناميكية `03_Dynamic_Prompt_Library/index.html` محدث بـ 21 خطافاً.
...
```mermaid
flowchart LR
    A["المستخدم / المطور"] -->|محفز الخطاف| B["نظام الخطافات Auto-Hooks (21 خطافاً)"]
